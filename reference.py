...
class Student:
    def __init__(self, root):
        ...
        title = Label(self.root, text="Student Management System", bd=6, relief=GROOVE, font=("Algerian", 30, 'bold'),
        ...
        title = Label(self.root, text="Developed By Mehrab Hossain Ope", bd=3, relief=GROOVE,
                      font=("Brush Script MT", 18), bg='blue', fg='white')
        ...
        m_title = Label(manage_frame, text="Manage Students", bg="light blue", fg="black",
                        font=("times new roman", 18, "bold"))
        m_title.grid(row=0, columnspan=2, pady=10)

        # sl_no
        lbl_sl = Label(manage_frame, text="Serial No", bg="light blue", fg="black",
        ...
        combo_class = ttk.Combobox(manage_frame, textvariable=self.class_var, font=("times new roman", 12, 'bold'),
                                   state='readonly')
        combo_class['values'] = (
        "Class 1", "Class 2", "Class 3", "Class 4", "Class 5", "Class 6", "Class 7", "Class 8", "Class 9", "Class 10")
        combo_class.grid(row=3, column=1, pady=10, padx=20)
        # Batch
        lbl_batch = Label(manage_frame, text="Batch Name", bg="light blue", fg="black",
                          font=("times new roman", 14, 'bold'))
        ...
        # admit date
        lbl_adate = Label(manage_frame, text="Payment Date", bg="light blue", fg="black",
                          font=("times new roman", 14, 'bold'))
        ...
        # Parents Mobile
        lbl_pmob = Label(manage_frame, text="Parents Mobile", bg="light blue", fg="black",
                         font=("times new roman", 14, 'bold'))
        ...
        # Pay
        lbl_pay = Label(manage_frame, text="Pay Amount", bg="light blue", fg="black",
                        font=("times new roman", 14, 'bold'))
        ...
        txt_pay = Entry(manage_frame, textvariable=self.pay_amount_var, width=5, font=('times new roman', 14), bd=2,
                        relief=GROOVE)
        ...
        txt_search = Entry(detail_frame, width=30, textvariable=self.search_txt, font=('times new roman', 14), bd=2,
                           relief=GROOVE)
